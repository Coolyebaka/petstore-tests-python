...
>
> ### БАГ!
> При создании проекта, был обнаружен баг.
> После изменения сущности, API не сразу отдает обновленные данные в ней, поэтому была реализована сложная логика retry'ев для того, чтобы все тесты были PASSED.
> Но в реальном проекте я бы направил баг-репорт команде разработки.
